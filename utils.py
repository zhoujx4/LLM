...
def get_model_tokenizer(model_name_or_path, model_type, device='auto'):
    ...
    if re.search("Qwen-\d+B-Chat", model_type):
        from transformers import AutoModelForCausalLM, AutoTokenizer
        from transformers.generation import GenerationConfig
        tokenizer = AutoTokenizer.from_pretrained("/mnt/SSD_12TB/model_gallery/Qwen-72B-Chat", trust_remote_code=True)
    ...
    elif re.search("Qwen(1.5|2)-\d+B-(Chat|Instruct)", model_type):
